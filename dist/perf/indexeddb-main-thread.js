...
const initBackend = makeInitBackend('__absurd:spawn-idb-worker', () =>
  import('./indexeddb-main-thread-worker-33477030.js')
);
const initCryptoBackend = makeInitBackend('__absurd:spawn-crypto-worker', () =>
  import('./indexeddb-main-thread-crypto-worker-e0d1ed3f.js')
);

export { initBackend, initCryptoBackend };
